...
#$FSLUNC = "\\azurefilesupd.file.core.windows.net\wvdups"
...
#REG ADD "HKLM\SOFTWARE\Policies\Microsoft\OneDrive" /v "KFMSilentOptIn" /t REG_SZ /d "9716dc2d-25b2-4ef9-8030-7090f9acbbb3" /f
...
#Disable Drive redirection and clipboard
New-ItemProperty -Path "HKLM:\Software\Microsoft\Terminal Server Client\" -Name "DisableDriveRedirection" -Value 1 -Type DWord -Force
New-ItemProperty -Path "HKLM:\Software\Microsoft\Terminal Server Client\" -Name "DisableClipboardRedirection" -Value 1 -Type DWord -Force
...
#New-ItemProperty -Path HKLM:\Software\FSLogix\Profiles -Name "VHDLocations" -Value \\azurefilesupd.file.core.windows.net\wvdups -PropertyType MultiString -Force
#Set-ItemProperty -Path HKLM:\Software\FSLogix\Profiles -Name "SizeInMBs" -Type "Dword" -Value "1000"
